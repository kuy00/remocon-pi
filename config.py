...
# ── HTTP 서버 (ir_server.py) ─────────────────────────────
HTTP_HOST = os.getenv("IR_HTTP_HOST", "0.0.0.0")      # listen 주소 (LAN 전체=0.0.0.0)
HTTP_PORT = _int("IR_HTTP_PORT", 8000)
HTTP_TOKEN = os.getenv("IR_HTTP_TOKEN", "")           # 설정 시 Bearer 토큰 요구(빈값=무인증)
